...
const description =
  "Track feeds, sleep, diapers, growth and milestones with trusted medical guidance built into every recommendation.";
...
export const metadata: Metadata = {
  ...
  verification: {
    google: "Y9zzKEeTkDSYslnDuwtfNl0KMHaO8TukiAW9mVNLEfE",
  },
